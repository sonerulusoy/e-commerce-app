    ...
    if (typeof charge.payment_intent === "string") {
      try {
        ...
        if (existingOrder?.status === "complete") {
          ...
          console.log("payment_intent is not a string for charge:", charge.id);
          return res.status(200).send("payment_intent is not a string");
        }
      ...
      console.log("payment_intent isi not a string for charge:", charge.id);
      return res.status(200).send("payment_intent is not a string");
    }
